...
static inline const char* MdnsEntryGetName(const MdnsEntry* entry) {
    return entry->name;
}

static inline const char* MdnsEntryGetHost(const MdnsEntry* entry) {
    return entry->host;
}

static inline const char* MdnsEntryGetDomain(const MdnsEntry* entry) {
    return entry->domain;
}

static inline uint16_t MdnsEntryGetPort(const MdnsEntry* entry) {
    return entry->port;
}

static inline uint32_t MdnsEntryGetInterface(const MdnsEntry* entry) {
    return entry->iface;
}

static inline const char* MdnsEntryGetTxtVers(const MdnsEntry* entry) {
    return entry->txtvers;
}

static inline const char* MdnsEntryGetId(const MdnsEntry* entry) {
    return entry->id;
}

static inline const char* MdnsEntryGetPath(const MdnsEntry* entry) {
    return entry->path;
}

static inline const char* MdnsEntryGetSki(const MdnsEntry* entry) {
    return entry->ski;
}

static inline const char* MdnsEntryGetRegister(const MdnsEntry* entry) {
    return entry->reg;
}

static inline const char* MdnsEntryGetBrand(const MdnsEntry* entry) {
    return entry->brand;
}

static inline const char* MdnsEntryGetType(const MdnsEntry* entry) {
    return entry->type;
}

static inline const char* MdnsEntryGetModel(const MdnsEntry* entry) {
    return entry->model;
}
