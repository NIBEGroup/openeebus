...
/**
 * @file
 * @brief Customer Energy Manager OHPCF use case internal declarations
 */

#ifndef SRC_USE_CASE_ACTOR_CEM_CEM_OHPCF_INTERNAL_H_
#define SRC_USE_CASE_ACTOR_CEM_CEM_OHPCF_INTERNAL_H_
...
typedef struct CemOhpcfUseCase CemOhpcfUseCase;
struct CemOhpcfUseCase {
  /** Inherits the Entity */
  UseCase obj;
...
#define CEM_OHPCF_USE_CASE(obj) ((CemOhpcfUseCase*)(obj))
...
#endif  // SRC_USE_CASE_ACTOR_CEM_CEM_OHPCF_INTERNAL_H_
