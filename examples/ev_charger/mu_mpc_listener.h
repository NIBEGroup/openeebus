...
/**
 * @file
 * @brief MU MPC Listener declarations for EV Charger
 */

#ifndef EXAMPLES_EV_CHARGER_MU_MPC_LISTENER_H_
#define EXAMPLES_EV_CHARGER_MU_MPC_LISTENER_H_
...
#endif  // EXAMPLES_EV_CHARGER_MU_MPC_LISTENER_H_
