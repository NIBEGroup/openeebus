...
/**
 * @file
 * @brief Test Smart Energy Management PS write partial with sequence id only
 */
...
{"smartEnergyManagementPsData": [
  {"alternatives": [
    ...
    [
      ...
      {"powerSequence": [
        [
          {"description": [{"sequenceId": 2}, {"powerUnit": "W"}]},
          {"state": [{"state": "inactive"}]}
        ]
      ]}
    ],
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(FunctionUpdateTestInput{
        .description        = "Test Smart Energy Management PS write partial with sequence id only"sv,
