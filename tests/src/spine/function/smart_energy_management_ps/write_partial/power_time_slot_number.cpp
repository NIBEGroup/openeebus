...
/**
 * @file
 * @brief Test Smart Energy Management PS write partial with slot number id only
 */
      ...
      {"powerSequence": [
        [
          {"powerTimeSlot": [
            [
              {"schedule": [{"slotNumber": 2}]},
              {"valueList": [{"value": [[{"valueType": "powerMax"}, {"value": [{"number": 2000}]}]]}]}
            ]
          ]}
        ]
      ]}
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(FunctionUpdateTestInput{
        .description        = "Test Smart Energy Management PS write partial with slot number id only"sv,
